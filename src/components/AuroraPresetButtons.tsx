...
const presets: AuroraPreset[] = [
  {
    ...
    colors: { color1: '#00ff87', color2: '#60efff', color3: '#0ea5e9' },
    opacity: 0.35,
    blur: 80,
    mouseFollow: 0.6,
  },
  ...
  {
    name: 'Ocean Deep',
    colors: { color1: '#0077b6', color2: '#00b4d8', color3: '#0096c7' },
    opacity: 0.35,
    blur: 100,
    mouseFollow: 0.3,
  },
  {
    name: 'Cosmic Purple',
    colors: { color1: '#7c3aed', color2: '#a78bfa', color3: '#c084fc' },
    opacity: 0.3,
    blur: 85,
    mouseFollow: 0.7,
  },
  {
    name: 'Minimal Frost',
    colors: { color1: '#94a3b8', color2: '#cbd5e1', color3: '#e2e8f0' },
    opacity: 0.2,
    blur: 120,
    mouseFollow: 0.2,
  },
